...
class AoS(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for F in (LoginScreen, HomeScreen, ProblemInterface, UserHome,
                  UserInterface, AssignmentsInterface):
    ...
    def verify_creds(self, controller):
        ...
        try :
            ...
            if (creds[1] == user_details[0][4]):
                ...
                showinfo("Fail", "We do not have that user information. Please try again!")
    ...
    def init_window(self, controller):
        ...
        for button in self.buttons:
            ...
            if button == "View Assignments":
                new_button["command"] = lambda : controller.show_frame(AssignmentsInterface)
            elif (button == "Logout"):
...
class AssignmentsInterface(GUISkeleton):
    '''
    ...
    def __init__(self, parent, controller):
        ...
        # label at top of the frame
        title = self.create_label(self, "Assignments\n",
                                  TITLE_FONT,
