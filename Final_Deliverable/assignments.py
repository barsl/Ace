...
class AddAssignment(GUISkeleton):
    ...
    def refresh(self):
        '''Function to destroy current widgets on database and refresh the screen
        '''
    ...
    def done(self):
        ...
        for uid in ids:
            ...
            db.add_attempt("a"+str(num), uid, prob_ids, progress, grade, sub_date, conn)
    ...
    def create_problem_set(self, formula):
        '''
        Function that returns a unique set
        of problems set according to the formula
        @param formula "subj1:num1,subj2:num2..." 
        '''
        problem_set = []
        pairs = {}
