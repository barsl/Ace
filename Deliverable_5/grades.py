...
class ViewStudentGrades(GUISkeleton):
	...
	def __init__(self, parent, controller):
		...
		self.buttons = ["Edit Grade", "View Attempts", "Back"]
		...
		self.title = self.create_label(self, "View Grades",
		...
		title = self.create_label(self, "Student Grades", TITLE_FONT)
